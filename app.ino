...
void handleRoot() {
  ...
  html += "</style>";
  // Replace the entire JavaScript section in handleRoot() function with this:

html += "<script>";
// Define all functions at the global scope first
...
html += "</script>";
  ...
  html += "<div class='tab'>";
html += "<button class='tablinks active' onclick='this.className += \" active\"; document.getElementById(\"status\").style.display = \"block\"; document.getElementById(\"weekday\").style.display = \"none\"; document.getElementById(\"friday\").style.display = \"none\"; document.getElementById(\"time\").style.display = \"none\"; document.getElementById(\"wifi\").style.display = \"none\";'>Status</button>";
html += "<button class='tablinks' onclick='this.className += \" active\"; document.getElementById(\"status\").style.display = \"none\"; document.getElementById(\"weekday\").style.display = \"block\"; document.getElementById(\"friday\").style.display = \"none\"; document.getElementById(\"time\").style.display = \"none\"; document.getElementById(\"wifi\").style.display = \"none\";'>Weekday Alarms</button>";
html += "<button class='tablinks' onclick='this.className += \" active\"; document.getElementById(\"status\").style.display = \"none\"; document.getElementById(\"weekday\").style.display = \"none\"; document.getElementById(\"friday\").style.display = \"block\"; document.getElementById(\"time\").style.display = \"none\"; document.getElementById(\"wifi\").style.display = \"none\";'>Friday Alarms</button>";
html += "<button class='tablinks' onclick='this.className += \" active\"; document.getElementById(\"status\").style.display = \"none\"; document.getElementById(\"weekday\").style.display = \"none\"; document.getElementById(\"friday\").style.display = \"none\"; document.getElementById(\"time\").style.display = \"block\"; document.getElementById(\"wifi\").style.display = \"none\";'>Set Time</button>";
html += "<button class='tablinks' onclick='this.className += \" active\"; document.getElementById(\"status\").style.display = \"none\"; document.getElementById(\"weekday\").style.display = \"none\"; document.getElementById(\"friday\").style.display = \"none\"; document.getElementById(\"time\").style.display = \"none\"; document.getElementById(\"wifi\").style.display = \"block\";'>WiFi Settings</button>";
html += "</div>";
...
void checkButtons() {
  ...
  if (upBtn == LOW && lastUpBtn == HIGH) {
    if (isSettingTime) {
      ...
      Alarm* currentAlarm = editingFriday ? 
                           &settings.fridayAlarms[currentAlarmEditing] : 
                           &settings.weekdayAlarms[currentAlarmEditing];
...
void checkAlarms() {
  ...
  for (int i = 0; i < 12; i++) {
    ...
    if (alarmsToCheck[i].hour == now.hour() &&
        alarmsToCheck[i].minute == now.minute() &&
        now.second() == 0) { // Trigger at the start of the minute
